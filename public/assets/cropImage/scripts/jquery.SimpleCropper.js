...
(function ($) {
    ...
    $.fn.simpleCropper = function (onComplete) {
        ...
        var jcrop_api;
        var bottom_html = "<form action ='site/product/CropNdUpload' method='post' id='dev_upImg_form' ><input type='hidden' id='base64_imgData' name='base64_imgData'><input type='file' id='fileInput' name='files[]'/ accept='image/*'><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel'></div><div class='ok'></div></div></div></form>";
        ...
        function preview() {
            ...
            document.getElementById('base64_imgData').value = dataUrl;
