                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >@if (Lang::has(Session::get('admin_lang_file').'.BACK_PAYUMONEY_SHIPPING_DELIVERY')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_PAYUMONEY_SHIPPING_DELIVERY')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_PAYUMONEY_SHIPPING_DELIVERY')}} @endif</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>@if (Lang::has(Session::get('admin_lang_file').'.BACK_PAYUMONEY_SHIPPING_DELIVERY')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_PAYUMONEY_SHIPPING_DELIVERY')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_PAYUMONEY_SHIPPING_DELIVERY')}} @endif</h5>
           ...
           <table aria-describedby="dataTables-example_info" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										<tr class="gradeA odd">
                                            ...
                                            <ul>
											<?php
												$product_data = DB::table('nm_order_payu')->orderBy('order_date', 'desc')->leftjoin('nm_product', 'nm_order_payu.order_pro_id', '=', 'nm_product.pro_id')->where('nm_order_payu.transaction_id', '=',$shipping->transaction_id)->where('nm_order_payu.order_type', '=',1)->get(); ?>
