         ...
         <body class="padTop53 " >
                  ...
                  <div class="inner">
                     ...
                     <center>
                        <div class="cal-search-filter">
                           <form  action="{!!action('TransactionController@adm_deal_payu_replacement_orders')!!}" method="POST">
                              ...
                              <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                       <a href="{{ url('').'/adm_deal_payu_replacement_orders' }}">
            ...
            <script>
               function show_replace_approved(data)
               {
               	...
               	$("#approve_replace").load('<?php echo url(''); ?>/adm_deal_get_approve_replacecontent_payu/'+data);
               }
            </script>
         </body>
         <!-- END BODY -->
