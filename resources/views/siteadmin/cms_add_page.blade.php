...
<head>
    <meta charset="UTF-8" />
    <title>{{ $SITENAME }} | {{ (Lang::has(Session::get('admin_lang_file').'.BACK_ADD_CMS_PAGE')!= '') ? trans(Session::get('admin_lang_file').'.BACK_ADD_CMS_PAGE') : trans($ADMIN_OUR_LANGUAGE.'.BACK_ADD_CMS_PAGE')}}</title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a href="#">{{(Lang::has(Session::get('admin_lang_file').'.BACK_ADD_CMS_PAGE')!= '') ? trans(Session::get('admin_lang_file').'.BACK_ADD_CMS_PAGE')  : trans($ADMIN_OUR_LANGUAGE.'.BACK_ADD_CMS_PAGE') }}</a></li>
                            </ul>
                    </div>
                </div>
...
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>{{(Lang::has(Session::get('admin_lang_file').'.BACK_ADD_CMS_PAGE')!= '') ? trans(Session::get('admin_lang_file').'.BACK_ADD_CMS_PAGE')  : trans($ADMIN_OUR_LANGUAGE.'.BACK_ADD_CMS_PAGE') }}</h5>
		...
		@endif
            {!! Form::open(array('url'=>'cms_add_page_submit','class'=>'form-horizontal','accept-charset' => 'utf-8')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input id="text1" maxlength="150" placeholder="{{ (Lang::has(Session::get('admin_lang_file').'.BACK_PAGE_TITLE')!= '') ?  trans(Session::get('admin_lang_file').'.BACK_PAGE_TITLE') : trans($ADMIN_OUR_LANGUAGE.'.BACK_PAGE_TITLE') }} {{ $default_lang }}" class="form-control" type="text" name="page_title" value="{!! Input::old('page_title') !!}" >
                    </div>
                </div>
				...
				<div class="form-group"> 
                    ...
                    <div class="col-lg-8">
                        <input id="text1" maxlength="150" placeholder="Enter Page Title In {{ $get_lang_name }}" class="form-control" type="text" name="page_title_<?php echo $get_lang_name; ?>" value="{!! Input::old('page_title_'.$get_lang_name) !!}" >
                    </div>
                </div>
				@endforeach
				@endif
					 ...
					 <div class="col-lg-11">
                        <div class="">
                            <div class="body collapse in">
                                <textarea id="wysihtml5" class="form-control" rows="10" name="page_description" placeholder="Enter Page Description {{ $default_lang }}">{!! Input::old('page_description') !!}</textarea>
				...
				<div class="form-group">
					<label for="text1" class="control-label col-lg-2">Page Description({{ $get_lang_name }}):<span class="text-sub">*</span></label>
					 ...
					 <div class="col-lg-11">
                        <div class="">
                            <div class="body collapse in">
                                <textarea id="wysihtml5" class="form-control" rows="10" name="page_description_{{ $get_lang_name }}" placeholder="Enter Page Description In {{ $get_lang_name }}">{!! Input::old('page_description_'.$get_lang_name) !!}</textarea>
							</div>
                        </div>
                    </div>
                </div>
