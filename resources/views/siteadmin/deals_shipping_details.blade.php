                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	...
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >{{ ((Lang::has(Session::get('admin_lang_file').'.BACK_SHIPPING_DELIVERY')!= ''))? trans(Session::get('admin_lang_file').'.BACK_SHIPPING_DELIVERY') : trans($ADMIN_OUR_LANGUAGE.'.BACK_SHIPPING_DELIVERY') }}</a></li>
...
<div class="col-lg-12">
    ...
    <div class="box dark">
        ...
        <header>
            ...
            <h5>{{ ((Lang::has(Session::get('admin_lang_file').'.BACK_SHIPPING_DELIVERY')!= ''))? trans(Session::get('admin_lang_file').'.BACK_SHIPPING_DELIVERY') : trans($ADMIN_OUR_LANGUAGE.'.BACK_SHIPPING_DELIVERY') }}</h5>
           ...
           <table aria-describedby="dataTables-example_info" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										<tr class="gradeA odd">
                                            ...
                                            <ul>
											<?php
												$product_data = DB::table('nm_order')->orderBy('order_date', 'desc')->leftjoin('nm_deals', 'nm_order.order_pro_id', '=', 'nm_deals.deal_id')->where('nm_order.transaction_id', '=',$shipping->transaction_id)->where('nm_order.order_type', '=',2)->get(); ?>
