...
<body class="padTop53 " >
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                               ...
                               <li class="active"><a>{{ ((Lang::has(Session::get('admin_lang_file').'.BACK_EXPIRED_DEALS')!= ''))? trans(Session::get('admin_lang_file').'.BACK_EXPIRED_DEALS') : trans($ADMIN_OUR_LANGUAGE.'.BACK_EXPIRED_DEALS') }}</a></li>
                            </ul>
                    </div>
                </div>
			  <center><div class="cal-search-filter">
		 
		 {{ Form::open(array('action' => 'DealsController@expired_deals','method'=> 'POST')) }}
 ...
 <span class="icon-calendar cale-icon"></span>
                             ...
                             <div class="col-sm-2">
								<a href="<?php echo url('').'/expired_deals';?>"><button type="button" name="reset" class="btn btn-block btn-info">{{ ((Lang::has(Session::get('admin_lang_file').'.BACK_RESET')!= ''))? trans(Session::get('admin_lang_file').'.BACK_RESET') : trans($ADMIN_OUR_LANGUAGE.'.BACK_RESET') }}</button></a>
							 </div>
							</div>
...
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>{{ ((Lang::has(Session::get('admin_lang_file').'.BACK_EXPIRED_DEALS')!= ''))? trans(Session::get('admin_lang_file').'.BACK_EXPIRED_DEALS') : trans($ADMIN_OUR_LANGUAGE.'.BACK_EXPIRED_DEALS') }}</h5>
