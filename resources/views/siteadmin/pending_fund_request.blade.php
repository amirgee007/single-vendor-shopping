...
<head>
    <meta charset="UTF-8" />
    <title>{{ $SITENAME }} | {{ (Lang::has(Session::get('admin_lang_file').'.BACK_PENDING_FUND_REQUEST')!= '') ? trans(Session::get('admin_lang_file').'.BACK_PENDING_FUND_REQUEST') : trans($ADMIN_OUR_LANGUAGE.'.BACK_PENDING_FUND_REQUEST') }}            </title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a > {{ (Lang::has(Session::get('admin_lang_file').'.BACK_PENDING_FUND_REQUEST')!= '') ?  trans(Session::get('admin_lang_file').'.BACK_PENDING_FUND_REQUEST') : trans($ADMIN_OUR_LANGUAGE.'.BACK_PENDING_FUND_REQUEST') }}                  </a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>{{ (Lang::has(Session::get('admin_lang_file').'.BACK_PENDING_FUND_REQUEST')!= '') ?  trans(Session::get('admin_lang_file').'.BACK_PENDING_FUND_REQUEST') : trans($ADMIN_OUR_LANGUAGE.'.BACK_PENDING_FUND_REQUEST') }}               </h5>
