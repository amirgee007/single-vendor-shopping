...
<html lang="en" class="ie8">
   ...
   <html lang="en" class="ie9">
      ...
      <html lang="en">
         ...
         <head>
            <meta charset="UTF-8" />
            <title>{{ $SITENAME }} | @if (Lang::has(Session::get('admin_lang_file').'.BACK_FAILED_ORDERS')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_FAILED_ORDERS') }} @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_FAILED_ORDERS') }} @endif</title>
            ...
            <div id="wrap">
               ...
               <div id="content">
                  <div class="inner">
                     <div class="row">
                        <div class="col-lg-12">
                           <ul class="breadcrumb">
                              ...
                              <li class="active"><a >@if (Lang::has(Session::get('admin_lang_file').'.BACK_FAILED_ORDERS')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_FAILED_ORDERS') }}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_FAILED_ORDERS') }} @endif</a></li>
                           </ul>
                        </div>
                     </div>
                     <center>
                        <div class="cal-search-filter">
                           <form  action="{!!action('TransactionController@deals_payu_failed_orders')!!}" method="POST">
                              ...
                              <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                       <a href="{{ url('').'/deals_payu_failed_orders' }}"><button type="button" name="reset" class="btn btn-block btn-info">@if (Lang::has(Session::get('admin_lang_file').'.BACK_RESET')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_RESET') }} @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_RESET') }} @endif</button></a>
                                    </div>
                                 </div>
                                 {{ Form::close()}}
                              </div>
                     ...
                     <h5>@if (Lang::has(Session::get('admin_lang_file').'.BACK_FAILED_ORDERS')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_FAILED_ORDERS') }} @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_FAILED_ORDERS') }} @endif</h5>
                     </header>
                     ...
                     <td class="center     "><a href="#" class="colr3">{{ $orderstatus }}
                     </a></td>
                     ...
                     <td class="     ">{{ $allorders_list->deal_title }}
