            ...
            <option value="0">---@if (Lang::has(Session::get('admin_lang_file').'.BACK_SELECT')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_SELECT')}}  @else {{trans($ADMIN_OUR_LANGUAGE.'.BACK_SELECT')}} @endif---</option>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                       <input required placeholder="@if (Lang::has(Session::get('admin_lang_file').'.BACK_NUMBERS_ONLY')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_NUMBERS_ONLY')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_NUMBERS_ONLY')}} @endif" class="form-control" value="{{ $products->wholesale_price }}" type="text" id="wholesale_price" name="wholesale_price" maxlength="10">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                       <input required placeholder="@if (Lang::has(Session::get('admin_lang_file').'.BACK_NUMBERS_ONLY')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_NUMBERS_ONLY')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_NUMBERS_ONLY')}} @endif" class="form-control" value="{{ $products->stock_quantity }}" type="text" id="stock_quantity" name="stock_quantity" maxlength="10">
