...
<html lang="en" class="ie8">
   ...
   <html lang="en" class="ie9">
      ...
      <html lang="en">
         ...
         <head>
            <meta charset="UTF-8" />
            <title>{{ $SITENAME }} {{ (Lang::has(Session::get('admin_lang_file').'.MER_CANCEL_ORDERS')!= '') ?  trans(Session::get('admin_lang_file').'.MER_CANCEL_ORDERS') :trans($ADMIN_OUR_LANGUAGE.'.MER_CANCEL_ORDERS') }}</title>
         ...
         <body class="padTop53 " >
            ...
            <div id="wrap">
               ...
               <div id="content">
                  <div class="inner">
                     <div class="row">
                        <div class="col-lg-12">
                           <ul class="breadcrumb">
                              ...
                              <li class="active"><a href="#">{{ (Lang::has(Session::get('admin_lang_file').'.BACK_CANCELLED_ORDER')!= '') ? trans(Session::get('admin_lang_file').'.BACK_CANCELLED_ORDER'): trans($ADMIN_OUR_LANGUAGE.'.BACK_CANCELLED_ORDER') }}</a></li>
                           </ul>
                        </div>
                     </div>
                     <center>
                        <div class="cal-search-filter">
                           {{ Form::open(array('action'=>'TransactionController@dealcod_cancel_orders','method'=>'POST')) }}
                           <!--  <form  action="{!!action('TransactionController@dealcod_cancel_orders')!!}" method="POST"> -->
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-3">
                                 <div class="item form-group">
                                    ...
                                    <div class="col-sm-6 place-size">
                                       ...
                                       <!--  <input type="text" placeholder="DD/MM/YYYY"  name="from_date"  class="form-control" id="datepicker-8"  value="<?php echo $from_date; ?>" required readonly> -->
                                    </div>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-2">
                                    <a href="{{ url('').'/adm_dealcod_cancel_orders' }}">
                     ...
                     <h5>{{ (Lang::has(Session::get('admin_lang_file').'.BACK_CANCELLED_ORDER')!= '') ? trans(Session::get('admin_lang_file').'.BACK_CANCELLED_ORDER') : trans($ADMIN_OUR_LANGUAGE.'.BACK_CANCELLED_ORDER') }}</h5>
                     </header>
                     ...
                     @endif
                     $total_tax = ($allorders_list->cod_amt * $allorders_list->cod_tax)/100;
                     <tr class="gradeA odd">
                     ...
                     <td class="center">
                     @if($allorders_list->cod_id==$allorders_list->cod_order_id) @if($allorders_list->cancel_status==1)<a href="javascript:void(0);"  class="btn btn-info" onclick="show_cancel_approved('<?php echo $allorders_list->delStatus_id;?>');">Cancel Request</a>  @endif @endif
                     </td>
                     @elseif($allorders_list->delivery_status == 6)  @if($allorders_list->cod_id==$allorders_list->cod_order_id) @if($allorders_list->cancel_status==2)  
                     <td class="center">
            ...
            <script>
               function show_cancel_approved(data)
               {
               	...
               	$("#approve_cancel").load('<?php echo url(''); ?>/adm_deal_get_approve_content/'+data);
               }
            </script>
         </body>
         <!-- END BODY -->
