...
{!!$merchantleftmenus!!}
        ...
        <div id="content">
		 ...
		 <form  action="{!!action('TransactionController@adm_deal_cancel_orders')!!}" method="POST">
...
placeholder="DD/MM/YYYY"  id="datepicker-9" class="form-control" value="<?php echo $to_date; ?>" required readonly> -->
                               ...
                               <div class="col-sm-2">
								<a href="{{ url('').'/adm_deal_cancel_orders' }}">
			...
			@foreach($calceled_order_alldeal as $allorders_list) 
				...
				@php	$total_tax = ($allorders_list->order_amt * $allorders_list->order_tax)/100 ; @endphp
					...
					@if($allorders_list->delivery_status == 5) 
							...
							</td> @endif  @else  <td>Order Cancelled</td>
					 @endif @endif
...
function show_cancel_approved(data)
{
	...
	$("#approve_cancel").load('<?php echo url(''); ?>/adm_deal_get_approve_content_paypal/'+data);
}
</script>
</body>
     <!-- END BODY -->
