...
<head>
    <meta charset="UTF-8" />
    <title>Bohrabazaar.net |Manage Publish Services </title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a>Manage Publish Services</a></li>
                            </ul>
                    </div>
                </div>
            <div class="row">
        ...
        <div id="div-1" class="accordion-body collapse in body">
           ...
           <table aria-describedby="dataTables-example_info" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
                                    <thead>
										...
										<th aria-label="Browser: activate to sort column ascending" style="width: 100px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Service Title</th>
										...
										<th aria-label="CSS grade: activate to sort column ascending" style="width: 100px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Service details</th>

										</tr>
                                    </thead>
                                    <tbody>
                                      <?php $i = 1 ;
									  foreach($services_details as $blog_list) { 
									  
									  if($blog_list->sr_status == 0)
									  {
										  $process = "<a href='".url('block_services/'.$blog_list->sr_id.'/1/1')."' > <i style='margin-left:10px;' class='icon icon-ok icon-me'></i> </a>";
								      } else if($blog_list->sr_status == 1) {
										   $process = "<a href='".url('block_services/'.$blog_list->sr_id.'/0/1')."' > <i style='margin-left:10px;' class='icon icon-ban-circle icon-me'></i> </a>";
									  }
									  ?>
                                    <tr class="gradeA odd">
                                            <td class="sorting_1"><?php echo $i; ?></td>
                                            <td class=""><?php echo substr($blog_list->sr_title,0,45); ?></td>
                                            <td class=""><?php echo $blog_list->sc_catname; ?> </td>
                                            <td class="center  "><?php echo $blog_list->sr_created_dt; ?></td>
											<td class="text-center"><a href="{!! url('edit_services').'/'.$blog_list->sr_id!!}"><i class="icon icon-edit icon-2x"></i></a></td>
											<td class="text-center"><?php echo $process; ?></td>
											<td class="text-center"><a href="{!! url('delete_services_submit').'/1'!!}"><i class="icon icon-trash icon-2x"></i></a></td>
                                            <td class="center  "><a href="<?php echo url('services_details')."/".$blog_list->sr_id; ?>">View details</a></td>
                                        </tr>
									<?php $i++; } ?>
