        ...
        <div id="content">
                ...
                <div class="inner">
				 ...
				 <center><div class="cal-search-filter">
				 	{{ Form::open(array('action'=>'TransactionController@dealcod_replacement_orders','method'=>'POST')) }}
		<!--  <form  action="{!!action('TransactionController@dealcod_replacement_orders')!!}" method="POST"> -->
...
{{ Form::text('to_date',$to_date,array('id'=>'datepicker-9','class'=>'form-control','placeholder'=>'DD/MM/YYYY','required'=>'required','readonly'=>'readonly')) }}
							<!--  <input type="text" name="to_date" placeholder="DD/MM/YYYY" id="datepicker-9" class="form-control" value="<?php echo $to_date; ?>" required readonly> -->
                               ...
                               <div class="col-sm-2">
								<a href="{{ url('').'/adm_dealcod_replacement_orders' }}">
...
<div class="col-lg-12">
 ...
 @if(isset($_POST['submit']))
			...
			@if($replace_order != "") 
			@foreach($replace_order as $allorders_list) 
...
@else
			...
			<tr class="gradeA odd">
                   ...
                   @if($allorders_list->delivery_status == 9)  
							<td class="center">@if($allorders_list->cod_id==$allorders_list->cod_order_id) 
								@if($allorders_list->replace_status==1)
							<a href="javascript:void(0);" class="btn btn-info" onclick="show_replace_approved('<?php echo $allorders_list->delStatus_id;?>');">Replace Request</a> @endif @endif
...
function show_replace_approved(data)
{
	...
	$("#approve_replace").load('<?php echo url(''); ?>/adm_deal_get_approve_replacecontent_cod/'+data);
}
</script>
</body>
     <!-- END BODY -->
