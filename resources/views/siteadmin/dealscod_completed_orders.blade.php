...
<html lang="en" class="ie8">
   ...
   <html lang="en" class="ie9">
      ...
      <html lang="en">
         ...
         <head>
            <meta charset="UTF-8" />
            <title>{{ $SITENAME }} |Deals COD Success Orders</title>
                     ...
                     <form  action="{!!action('TransactionController@dealscod_completed_orders')!!}" method="POST">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-3">
                              <div class="item form-group">
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <!-- <input type="text" name="from_date" placeholder="DD/MM/YYYY"  class="form-control" id="datepicker-8" required readonly value="<?php echo $from_date; ?>"> -->
                                 </div>
                              </div>
                           </div>
                           <div class="col-sm-3">
                              <div class="item form-group">
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <!--  <input type="text" name="to_date"  id="datepicker-9" placeholder="DD/MM/YYYY" class="form-control" required readonly value="<?php echo $to_date; ?>"> -->
                                 </div>
                              </div>
                           </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                 <a href="{{ url('').'/dealscod_completed_orders' }}"><button type="button" name="reset" class="btn btn-block btn-info">@if (Lang::has(Session::get('admin_lang_file').'.BACK_RESET')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_RESET') }} @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_RESET') }} @endif</button></a>
                              </div>
                           </div>
                     </form>
                  </center>
