                           ...
                           <form  action="{!!action('TransactionController@deals_all_orders')!!}" method="POST">
                              ...
                              <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                       <a href="{{ url('').'/deals_all_orders' }}"><button type="button" name="reset" class="btn btn-block btn-info">@if (Lang::has(Session::get('admin_lang_file').'.BACK_RESET')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_RESET') }} @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_RESET') }} @endif</button></a>
                                    </div>
                                 </div>
                           </form>
                     </center>
