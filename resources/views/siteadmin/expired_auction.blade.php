...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $SITENAME; ?> |Archive Auction</title>
        ...
        <div id="div-1" class="accordion-body collapse in body">
           ...
           <table aria-describedby="dataTables-example_info" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td class="center  "><a href="#"><img style="height:40px;" src="<?php echo url(''); ?>/public/assets/auction/<?php echo $auc_get_img[0]; ?>"></a></td>
