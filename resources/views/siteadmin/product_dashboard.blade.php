...
<head>
	...
	<title>{{ $SITENAME }} | @if (Lang::has(Session::get('admin_lang_file').'.BACK_PRODUCT_DASHBOARD')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_PRODUCT_DASHBOARD') }}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_PRODUCT_DASHBOARD')}} @endif </title>
                ...
                <div class="inner">
                    ...
                    <div class="col-lg-12">
                        	<ul class="breadcrumb">
                                ...
                                <li class="active"><a >@if (Lang::has(Session::get('admin_lang_file').'.BACK_PRODUCTS')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_PRODUCTS')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_PRODUCTS')}} @endif</a></li>
                            </ul>
                    </div>
                </div>
            <div class="">
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>@if (Lang::has(Session::get('admin_lang_file').'.BACK_PRODUCT_DASHBOARD')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_PRODUCT_DASHBOARD') }}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_PRODUCT_DASHBOARD')}} @endif</h5>
...
<br>
            	<div class="">
                 ...
                 <a style="color:#fff" href="<?php echo url(''); ?>" class="btn btn-success btn-sm btn-grad" target="_blank" >@if (Lang::has(Session::get('admin_lang_file').'.BACK_GO_TO_LIVE')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_GO_TO_LIVE')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_GO_TO_LIVE')}}@endif</a>
                    ...
                    <a style="color:#fff" href="{{ url('') }}/product_all_orders" class="btn btn-warning btn-sm btn-grad" target="_blank" >@if (Lang::has(Session::get('admin_lang_file').'.BACK_SEE_ALL_TRANSACTION')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_SEE_ALL_TRANSACTION')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_SEE_ALL_TRANSACTION')}}@endif</a>
 		 </div>
                </div>
                ...
                <div class="col-lg-6" style="padding:30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>@if (Lang::has(Session::get('admin_lang_file').'.BACK_TOTAL_PRODUCTS_COUNT')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_TOTAL_PRODUCTS_COUNT')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_TOTAL_PRODUCTS_COUNT')}} @endif</strong> 
                            <a href="#"><i class="icon icon-align-justify pull-right"></i></a>
                        </div>
                        <div class="panel-body">
                            @if(($act_count+$sold_cnt+$inactive_count)>0)
                           ...
                           <table width="60%" border="0">
                              <tbody><tr>
                                <td style="background:#4bb2c5">
                                    ...
                                    <span class="label label-danger">{{ $act_count }}</span>
                                </td>
                                ...
                                <span class="label label-danger">{{ $inactive_count }}</span>
                                </td>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>@if (Lang::has(Session::get('admin_lang_file').'.BACK_TOTAL_PRODUCTS_COUNT')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_TOTAL_PRODUCTS_COUNT')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_TOTAL_PRODUCTS_COUNT')}} @endif</td>
                                            <td>{{ $tot_pro= $active_count+$blocked_cnt }}</td>
                           </tr>
                                        <tr>
		...
		<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$tot_pro.'%"'; ?>;> 
		  <span class="sr-only">60% @if (Lang::has(Session::get('admin_lang_file').'.BACK_COMPLETE')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_COMPLETE') }}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_COMPLETE')}} @endif</span>
                                        ...
                                        <tr>
                                            <td>@if (Lang::has(Session::get('admin_lang_file').'.BACK_ACTIVE_PRODUCTS_COUNT')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_ACTIVE_PRODUCTS_COUNT')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_ACTIVE_PRODUCTS_COUNT') }} @endif</td>
                                            <td><?php //echo $sold_cnt;
												//$active_count=  $active_count-$sold_cnt;
										    	echo $act_count; 
                                         ...
                                         <tr>
                                           <td colspan="2"><div class="progress progress-striped active">
		<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:'.$act_count.'%"'; ?>;> 
		  <span class="sr-only">60% @if (Lang::has(Session::get('admin_lang_file').'.BACK_COMPLETE')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_COMPLETE') }}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_COMPLETE')}} @endif</span>
		</div>
	      </div></td>
                                        ...
                                        <tr>
                                            <td>@if (Lang::has(Session::get('admin_lang_file').'.BACK_SOLD_PRODUCTS_COUNT')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_SOLD_PRODUCTS_COUNT')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_SOLD_PRODUCTS_COUNT') }} @endif</td>
                                            <td>{{  $sold_cnt }}</td>
                                            
                                        </tr>
                                         <tr>
                                             <td colspan="2"><div class="progress progress-striped active">
		<div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"  <?php echo 'style="width:'.$sold_cnt.'%"'; ?>;>
		  <span class="sr-only">40% @if (Lang::has(Session::get('admin_lang_file').'.BACK_COMPLETE')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_COMPLETE') }}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_COMPLETE')}} @endif ( @if (Lang::has(Session::get('admin_lang_file').'.BACK_SUCCESS')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_SUCCESS')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_SUCCESS')}} @endif )</span>
										   ...
										   <tr>
                                            <td>@if (Lang::has(Session::get('admin_lang_file').'.BACK_INACTIVE_PRODUCTS_COUNT')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_INACTIVE_PRODUCTS_COUNT')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_INACTIVE_PRODUCTS_COUNT')}} @endif</td>
                                            <td> {{ $inactive_count }}</td>
                                            
                                        </tr>
                                         <tr>
                                             <td colspan="2"><div class="progress progress-striped active">
												<div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"  <?php echo 'style="width:'.$inactive_count.'%"'; ?>;>
												  <span class="sr-only">40% @if (Lang::has(Session::get('admin_lang_file').'.BACK_COMPLETE')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_COMPLETE') }}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_COMPLETE')}} @endif ( @if (Lang::has(Session::get('admin_lang_file').'.BACK_SUCCESS')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_SUCCESS')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_SUCCESS')}} @endif )</span>
												</div>
												  </div>
											</td>  
                ...
                <div class="col-lg-5"  style="padding-left:12px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>@if (Lang::has(Session::get('admin_lang_file').'.BACK_PRODUCTS_TRANS_DETAILS')!= '') {{ trans(Session::get('admin_lang_file').'.BACK_PRODUCTS_TRANS_DETAILS') }}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_PRODUCTS_TRANS_DETAILS')}} @endif</strong>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                      <tr>
                                            ...
                                            <td>@php echo ($producttdy[0]->count)+($producttdy_payu[0]->count)+($ordercod_tdy[0]->count); @endphp</td>
                                            <td>{{ Helper::cur_sym() }}<?php 
                                            if(($producttdy[0]->amt)||($producttdy_payu[0]->amt)||($ordercod_tdy[0]->amt))
                                            {
                                                

                                                echo (($producttdy[0]->amt+$producttdy[0]->tax+$producttdy[0]->ship)+($producttdy_payu[0]->amt+$producttdy_payu[0]->tax+$producttdy_payu[0]->ship)+($ordercod_tdy[0]->amt+$ordercod_tdy[0]->tax+$ordercod_tdy[0]->ship));
                                            }else{
                                                echo "-";
                                            }?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($product7days[0]->count)+($product7days_payu[0]->count)+($ordercod_7days[0]->count);?></td>
                                            <td>{{ Helper::cur_sym() }}<?php 
                                            if(($product7days[0]->amt)+($product7days_payu[0]->amt)+($ordercod_7days[0]->amt)){
                                                echo (($product7days[0]->amt+$product7days[0]->tax+$product7days[0]->ship)+($product7days_payu[0]->amt+$product7days_payu[0]->tax+$product7days_payu[0]->ship)+($ordercod_7days[0]->amt+$ordercod_7days[0]->tax+$ordercod_7days[0]->ship));
                                            }else{echo "-";}?></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><?php echo ($product30days[0]->count)+($product30days[0]->count)+($product30days_payu[0]->count)+($ordercod_30days[0]->count);?></td>
                                            <td>{{ Helper::cur_sym() }}<?php 
                                            if(($product30days[0]->amt)+($product30days_payu[0]->amt)+($ordercod_30days[0]->amt)){
echo (($product30days[0]->amt+$product30days[0]->tax+$product30days[0]->ship)+
    ($product30days_payu[0]->amt+$product30days_payu[0]->tax+$product30days_payu[0]->ship)+
    ($ordercod_30days[0]->amt+$ordercod_30days[0]->tax+$ordercod_30days[0]->ship));
                                            }else{echo "-";}?></td>
                                            
                                        </tr>
										 <tr>
                                            <td>@if (Lang::has(Session::get('admin_lang_file').'.BACK_LAST')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_LAST')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_LAST')}} @endif 1 @if (Lang::has(Session::get('admin_lang_file').'.BACK_YEAR')!= '') {{  trans(Session::get('admin_lang_file').'.BACK_YEAR')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_YEAR')}} @endif </td>
                                            <td><?php echo ($product12mnth[0]->count)+($product12mnth_payu[0]->count)+($ordercod_12days[0]->count);?></td>
                                            <td>{{ Helper::cur_sym() }}<?php 
                                            if(($product12mnth[0]->amt)+($product12mnth_payu[0]->amt)+($ordercod_12days[0]->amt)){
echo (($product12mnth[0]->amt+$product12mnth[0]->tax+$product12mnth[0]->ship)
    +($product12mnth_payu[0]->amt+$product12mnth_payu[0]->tax+$product12mnth_payu[0]->ship)
    +($ordercod_12days[0]->amt+$ordercod_12days[0]->tax+$ordercod_12days[0]->ship));
                                            }else{echo "-";}?></td>
                         ...
                         <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                              <ul class="nav nav-pills">
                                <li class="active"><a >@if (Lang::has(Session::get('admin_lang_file').'.BACK_LAST_ONE_YEAR_TRANSACTIONS_REPORT')!= '') {{ trans(Session::get('admin_lang_file').'.BACK_LAST_ONE_YEAR_TRANSACTIONS_REPORT')}}  @else {{ trans($ADMIN_OUR_LANGUAGE.'.BACK_LAST_ONE_YEAR_TRANSACTIONS_REPORT')}} @endif</a>
                                </li>
                              </ul>
   ...
   {!! $adminfooter !!}
	...
	plot6 = $.jqplot('chart6', [[{{ $act_count }},{{ $sold_cnt }} ,{{ $inactive_count }}]], {seriesDefaults:{renderer:$.jqplot.PieRenderer } });
		});
	</script>
    @endif
