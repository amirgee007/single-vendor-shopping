 ...
 <!-- HEADER SECTION -->
       ...
       <div class="inner">
          ...
          @endif
				...
				<form method="post" action="{{url('/product_image_bulk_upload_submit')}}" enctype="multipart/form-data" style="padding: 10px;">
					...
					<input type="submit" class="btn btn-success" name="btn_zip"value="Zip Upload" />  
							...
							<form action="{{url('/product_bulk_upload_submit')}}" method="post" enctype="multipart/form-data" style="padding: 10px;">
						    	 <input type="hidden" name="_token" value="{{ csrf_token() }}">
						        <div class="form-group">
