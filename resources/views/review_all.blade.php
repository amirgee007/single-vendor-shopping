 ...
 <div class="container">
        <div class="Ratings-review">
            <div class="review-title">
               ...
               <?php 
			   if(Session::has('customerid')){ ?> <a href="#review-comment">Write a Review</a> <?php 
			   }else{ ?>
            ...
            <div class="review-product-top">
					...
					if((Session::get('lang_code'))== '' || (Session::get('lang_code'))== 'en') { 
						$pro_title = 'pro_title';
							...
							echo  $pro_details_by_id->$pro_title; ?></h5>
            				<img src="<?php echo url('public/assets/product/').'/'.$product_img[0];?>" style="width:200px; height:170px;">

            		 </div>
            		 <div class="review-product-mid">

						<div class="review-Price">
							<p class="old-price"> <strike>{{ Helper::cur_sym() }} <?php echo  $pro_details_by_id->pro_price; ?></strike></p>
							<p class="new-price">{{ Helper::cur_sym() }} <?php echo  $pro_details_by_id->pro_disprice; ?> <span class="offer">(<?php echo round($pro_details_by_id->pro_discount_percentage);?>% off)</span></p>
	...
	<?php if(count($review_details)!=0){ 
			foreach($review_details as $col){
				...
				$final_date = date('M j, Y', strtotime($col->review_date) );
					...
					$day_difference =  $since_start->days;
					$hour_difference = $since_start->h;
					$minute_difference = $since_start->i;
					$sec_difference = $since_start->s;
		...
		?>
                  ...
                  <h6>by <?php echo $customer_name; ?> on <?php echo $final_date; ?>
				  
				  
				  <?php //if($day_difference>=1) echo $final_date;
	                           //else{ if($hour_difference<24){  if($hour_difference==0 && $minute_difference< 59 ) { echo $minute_difference . ' minutes ';  } elseif($hour_difference==0 && $minute_difference== 0 ) { if($sec_difference>0) echo $sec_difference.' seconds'; } else {  echo $hour_difference .' hours '.$minute_difference . ' minutes'; } } 	echo ' ago'; }?>
                     ...
                     <div class="item">
						...
						if(($product_image[0]!='')){ 
							if($mcat != '' && $smcat != '' && $sbcat != '' && $ssbcat != '') { ?>
								<a href="<?php echo url('productview/'.$mcat.'/'.$smcat.'/'.$sbcat.'/'.$ssbcat.'/'.$res); ?>"><img src="<?php echo url('public/assets/product/').'/'.$product_image[0];?>" alt="" style="height:215px;" /></a>
					  <?php } 
							if($mcat != '' && $smcat != '' && $sbcat != '' && $ssbcat == '') { ?>
								<a href="<?php echo url('productview/'.$mcat.'/'.$smcat.'/'.$sbcat.'/'.$res);?>"><img alt="" src="<?php echo url('public/assets/product/').'/'.$product_image[0];?>" style="height:215px;" ></a>
					  <?php }
							if($mcat != '' && $smcat != '' && $sbcat == '' && $ssbcat == '') { ?>
								<a href="<?php echo url('productview/'.$mcat.'/'.$smcat.'/'.$res); ?>"><img alt="" src="<?php echo url('public/assets/product/').'/'.$product_image[0];?>" style="height:215px;" ></a>
					 <?php }
						}else{ ?>
								<a href="#"><img alt="" src="<?php echo url('public/assets/product/').'/No_Image_Available.png';?>" style="height:215px;" ></a>
				  <?php } ?>
                        </div>
                        <p><?php 
					if((Session::get('lang_code'))== '' || (Session::get('lang_code'))== 'en') { 
						...
						echo substr ($product_det->$pro_title,0,20);?></p>
                        <h5>{{ Helper::cur_sym() }} <?php echo $product_det->pro_disprice;?></h5>
                     </div>
                  </a>
				  <?php   } //if
				} //foreach ?>  
