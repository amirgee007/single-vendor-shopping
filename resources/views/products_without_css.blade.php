					...
					<div class="product__info">
					 @if($product_det->pro_discount_percentage!='' && round($product_det->pro_discount_percentage)!=0)
						...
						<div class="img productViewCenter">
							@if($mcat != '' && $smcat != '' && $sbcat != '' && $ssbcat != '') 
							<a href="{!! url('productview').'/'.$mcat.'/'.$smcat.'/'.$sbcat.'/'.$ssbcat.'/'.$res!!}"><img class="product__image" src="{{ $prod_path }}" alt="{{ $alt_text }}" style="height: 200px; width: 200px" "title=""/></a>
							@endif
							@if($mcat != '' && $smcat != '' && $sbcat != '' && $ssbcat == '') 
							<a href="{!! url('productview').'/'.$mcat.'/'.$smcat.'/'.$sbcat.'/'.$res!!}" ><img class="product__image" style="height: 200px; width: 200px" alt="" src="{{ $prod_path }}"></a>
							@endif
							@if($mcat != '' && $smcat != '' && $sbcat == '' && $ssbcat == '') 
							<a href="{!! url('productview').'/'.$mcat.'/'.$smcat.'/'.$res!!}" ><img class="product__image" style="height: 200px; width: 200px" alt="{{ $alt_text }}" src="{{ $prod_path }}"></a>

							@endif
							
							@if($mcat != '' && $smcat == '' && $sbcat == '' && $ssbcat == '') 
							<a href="{!! url('productview').'/'.$mcat.'/'.$res!!}" ><img class="product__image" style="height: 200px; width: 200px" alt="{{ $alt_text }}" src="{{ $prod_path }}"></a>
