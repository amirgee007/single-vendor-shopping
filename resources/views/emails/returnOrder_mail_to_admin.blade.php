...
<table border="0" cellspacing="0" cellpadding="0" width="600" align="center" style="border:1px solid #cccccc; font-family:Montserrat"">
  ...
  <tr bgcolor="#f5f5f5"> 
        ...
        if(file_exists($SITE_LOGO))
          $logo = $SITE_LOGO;
        ?> 
          <td align="center"><img src="<?php echo $logo; ?>" alt="<?php echo $SITENAME; ?>" style="margin:20px; background:#f5f5f5;"/></td>
  </tr>
...
<tr>
  ...
  <tr bgcolor="#f5f5f5">
    <td style="height:50px;text-align:center; font-size:14px; color:#333333;"><a href="<?php echo url('');?>" target="_blank"  style="text-decoration:none;color:#ff8400;font-weight:800;"> &copy; <?php echo date("Y"); ?>&nbsp; <?php echo $SITENAME;?> </a></td>
  </tr>
