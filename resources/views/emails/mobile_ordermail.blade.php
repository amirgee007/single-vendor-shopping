    ...
    border: #ff9800 solid 1px;padding:8px 0;text-decoration:none;border-radius:2px;display:block;color:#fff;font-size:13px" href="" align="center" target="_blank"> <span style="color:#ffffff;font-size:13px;"><?php if (Lang::has(Session::get('lang_file').'.VIEW_YOUR_ORDER')!= '') { echo  trans(Session::get('lang_file').'.VIEW_YOUR_ORDER');}  else { echo trans($OUR_LANGUAGE.'.VIEW_YOUR_ORDER');} ?></span> </a> </p> </td> </tr> </tbody></table>
			...
			<table width="100%" cellspacing="0" cellpadding="0" style="line-height:1.5"> <!-- max-width:600px; -->
				<tbody>
					...
					/*select * from `nm_ordercod` left join `nm_product` on `nm_product`.`pro_id` = `nm_ordercod`.`cod_pro_id` left join `nm_deals` on `nm_deals`.`deal_id` = `nm_ordercod`.`cod_pro_id` left join `nm_merchant` on `nm_merchant`.`mer_id` = `nm_product`.`pro_mr_id` where `cod_transaction_id` = ORDERA4C7D5a6*/
					...
					<tr>  
						...
						<td align="center" valign="top" style="padding:12px 10px 0 10px;margin:0;vertical-align:top;min-width:100px"> <p style="padding:0;margin:0"> <a style="text-decoration:none;color:#000" href="" target="_blank"><p style="color:#565656;font-size:13px"><?php if($v->cod_order_type==1) {  if($langCode!='en') { $pro_title_dynamic = 'pro_title_'.$langCode;  $v->pro_title = $v->$pro_title_dynamic; }  echo $v->pro_title; } elseif($v->cod_order_type==2) {  if($langCode!='en') { $deal_title_dynamic = 'deal_title_'.$langCode;  $v->deal_title = $v->$deal_title_dynamic; } echo $v->deal_title; } ?>&nbsp;<sup></sup></p></td>  
						
						<td valign="top" align="center" style="padding:12px 10px 0 5px;margin:0;text-align:center"> <p style="padding:7px 0 0 0;margin:0;color:#565656;font-size:13px">{{ Helper::cur_sym() }} {{ $v->cod_prod_unitPrice  }} <?php //echo $v->pro_disprice; ?></p> </td>
						
						<td valign="top" align="center" style="padding:12px 10px 0 5px;margin:0;text-align:center"> <p style="padding:7px 0 0 0;margin:0;color:#565656;font-size:13px"><?php echo $v->cod_qty; ?></p> </td>
						
						<td valign="top" align="center" style="padding:12px 10px 0 5px;margin:0;text-align:center"> <p style="margin:0;padding:7px 0 0 0;color:#565656;font-size:13px">  {{ Helper::cur_sym() }} <?php echo $v->cod_amt; ?></p> </td>
						
						<td valign="top" align="center" style="padding:12px 10px 0 5px;margin:0;text-align:center"> <p style="margin:0;padding:7px 0 0 0;color:#565656;font-size:13px">  <?php echo $v->cod_tax,'%'; ?></p> </td>
						
						<td valign="top" align="center" style="padding:12px 10px 0 5px;margin:0;text-align:center"> <p style="margin:0;padding:7px 0 0 0;color:#565656;font-size:13px">  {{ Helper::cur_sym() }} <?php if($v->cod_order_type==1) { echo $v->cod_shipping_amt; } else { echo "0.00"; } ?></p> </td> 
						<?php /*
						<td valign="top" align="center" style="padding:12px 10px 0 5px;margin:0;text-align:center"> <p style="margin:0;padding:7px 0 0 0;color:#565656;font-size:13px">  
						{{ Helper::cur_sym() }} <?php if($v->cod_order_type==1) { echo $v->coupon_amount; } else { echo "0.00"; } ?>
						</p> </td> */?>
						<?php
						...
						<td valign="top" align="center" style="padding:12px 20px 0 5px;margin:0;text-align:center"> <p style="padding:7px 0 0 0;margin:0;color:#565656;font-size:13px">{{ Helper::cur_sym() }} <?php echo $total; ?></p> </td>
					</tr> 
					...
					<tr>  
						...
						<td valign="top" align="center" style="padding:12px 10px 0 10px;margin:0;text-align:center"> <p style="padding:7px 0 0 0;margin:0;color:#565656;font-size:13px; font-weight:bold;">  <?php if (Lang::has(Session::get('lang_file').'.TOTAL')!= '') { echo  trans(Session::get('lang_file').'.TOTAL');}  else { echo trans($OUR_LANGUAGE.'.TOTAL');} ?></p> </td>
						...
						<td valign="top" align="center" style="padding:12px 10px 0 10px;margin:0;text-align:center"> <p style="margin:0;padding:7px 0 0 0;color:#565656;font-size:13px; font-weight:bold;">{{ Helper::cur_sym() }} <?php echo $total_item_amt; ?></p> </td>
						
						<td valign="top" align="center" style="padding:12px 10px 0 10px;margin:0;text-align:center"> <p style="margin:0;padding:7px 0 0 0;color:#565656;font-size:13px; font-weight:bold;">  {{ Helper::cur_sym() }} <?php echo $total_tax_amt; ?></p> </td>
						
						<td valign="top" align="center" style="padding:12px 10px 0 10px;margin:0;text-align:center"> <p style="margin:0;padding:7px 0 0 0;color:#565656;font-size:13px; font-weight:bold;">{{ Helper::cur_sym() }} <?php echo $total_ship_amt; ?></p> </td> 
						<?php /*
						<td valign="top" align="center" style="padding:12px 10px 0 10px;margin:0;text-align:center"> <p style="margin:0;padding:7px 0 0 0;color:#565656;font-size:13px; font-weight:bold;">  
						...
						<td valign="top" align="center" style="padding:12px 20px 0 10px;margin:0;text-align:center"> <p style="padding:7px 0 0 0;margin:0;color:#565656;font-size:13px; font-weight:bold;">{{ Helper::cur_sym() }} <?php echo $total_amount;?></p> </td>
					</tr> 
				</tbody>
			</table>
...
<table width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;line-height:2.5">
  ...
  ?>
   ...
   <td width="33%" valign="top" align="center" style="padding:12px 20px 0 10px;margin:0;text-align:center"> <p style="white-space:nowrap;padding:7px 0 0 0;margin:0;color:#565656;font-size:13px; font-weight:bold;">  
   <?php if (Lang::has(Session::get('lang_file').'.WALLET_APPLIED')!= '') { echo  trans(Session::get('lang_file').'.WALLET_APPLIED');}  else { echo trans($OUR_LANGUAGE.'.WALLET_APPLIED');} ?> 
   </p>
   </td>
  <?php  } ?>
</tr>
