...
<table border="0" cellspacing="0" cellpadding="0" width="600" align="center" style="border:1px solid #cccccc;font-family:Montserrat"">
  ...
  <tr>
     <td style=" margin:0 auto; font-size:16px;text-align:left;padding:10px 10px 10px; color:#333333; background:#f5f5f5;">
...
<tr>
  ...
  <tr>
    <td style="height:50px;text-align:center; font-size:14px; background:#f5f5f5;"><a href="<?php echo url('');?>" target="_blank"  style="text-decoration:none;color:#ff8400;font-weight:800;"> &copy; <?php echo date("Y"); ?>&nbsp; <?php echo $SITENAME;?> </a></td>
  </tr>
