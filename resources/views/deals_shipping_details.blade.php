...
<div  id="<?php echo 'uiModal'.$i?>" class="modal fade in" style="display:none;">
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" style="border-bottom:none;">
                                                ...
                                                <div class="col-lg-4"><img src="public/assets/logo/logo.png" alt="" style="width:100px;height:30px;"></div>
                                      ...
                                      <b><?php if (Lang::has(Session::get('lang_file').'.AMOUNT_PAID')!= '') { echo  trans(Session::get('lang_file').'.AMOUNT_PAID');}  else { echo trans($OUR_LANGUAGE.'.AMOUNT_PAID');} ?> :<?php echo "$ ".$shipping->order_amt;?></b>
					 ...
					 <span><?php if (Lang::has(Session::get('lang_file').'.ORDER_DATE')!= '') { echo  trans(Session::get('lang_file').'.ORDER_DATE');}  else { echo trans($OUR_LANGUAGE.'.ORDER_DATE');} ?>: <?php echo $shipping->order_date;?></span>
                                          ...
                                          <strong><?php if (Lang::has(Session::get('lang_file').'.PHONE')!= '') { echo  trans(Session::get('lang_file').'.PHONE');}  else { echo trans($OUR_LANGUAGE.'.PHONE');} ?>:<?php echo $shipping->ship_phone;?></strong>
