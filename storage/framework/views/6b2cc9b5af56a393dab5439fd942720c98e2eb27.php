...
<!--Language drop down form-->
	...
	<select name="Language_change" id="Language_change" onchange="Lang_change()">
		<?php foreach($Active_Language as $Active_Lang) {?>
			<option value="<?php echo e($Active_Lang->lang_code); ?>" <?php if($selected_lang_code==$Active_Lang->lang_code): ?>
				selected 
			<?php endif; ?> ><?php echo e($Active_Lang->lang_name); ?></option>
		<?php } ?>
	</select> 
	<?php } ?>
...
<p class="alert-dismissable" id="success"><?php echo e(Session::get('login_message')); ?>
