...
Bootstrap style --> 
    ...
    <link id="callCss" rel="stylesheet" href="<?php echo e(url('')); ?>/themes/bootshop/bootstrap.min.css" media="screen"/>
    ...
    <?php //} ?>
<link href="<?php echo e(url('')); ?>/themes/css/green-theme.css" rel="stylesheet" media="screen"/>
<link href="<?php echo e(url('')); ?>/themes/css/jquery.colorpanel.css" rel="stylesheet" media="screen"/>
<!-- validation (Register Page)(newsletter)-->
   <link href='https://fonts.googleapis.com/css?family=Patua+One' rel='stylesheet' type='text/css'>
   <link rel="stylesheet" href="<?php echo e(url('')); ?>/themes/css/simpleform.css">
...
<!-- Google-code-prettify (Register Page)-->    
    <link href="<?php echo e(url('')); ?>/themes/css/jquery-gmaps-latlon-picker.css" rel="stylesheet"/>  
<!-- fav and touch icons -->
    <?php 
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo e(url('')); ?>/public/assets/favicon/<?php echo $fav->imgs_name; ?>">
    ...
    <!--<link href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet" />
     ...
     <link rel="stylesheet" href="<?php echo e(url('')); ?>/themes/css/normalize.css" />
     <link rel="stylesheet" href="<?php echo e(url('')); ?>/themes/css/styles.min.css" />
     <link href="<?php echo e(url('')); ?>/themes/css/jplist.min.css" rel="stylesheet" type="text/css" />    
   ...
   <script src="<?php echo url(''); ?>/themes/js/modernizr.min.js"></script> 
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(url('')); ?>/themes/css/compare-products/demo.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo e(url('')); ?>/themes/css/compare-products/component.css" />
        <link href="<?php echo e(url('')); ?>/themes/css/leftmenu.css" rel="stylesheet" media="screen"/>
        <style type="text/css" id="enject"></style>
...
<span  style="color:#F00">*</span></label> 
  ...
  <select class="form-control" name="selectcountry" id="selectcountry" onChange="get_city_list(this.value);">
      ...
      <?php $__currentLoopData = $country_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <option  value="<?php echo $country->co_id;?>"><?php echo $country->co_name; ?></option>
...
<?php if($Active_Language_count > 1) { ?>
	<select name="Language_change" id="Language_change" onchange="Lang_change()">
		<?php foreach($Active_Language as $Active_Lang) {?>
			<option value="<?php echo e($Active_Lang->lang_code); ?>" <?php if($selected_lang_code==$Active_Lang->lang_code): ?>selected <?php endif; ?> ><?php echo e($Active_Lang->lang_name); ?></option>
		<?php } ?>
	</select>
	<?php } ?>
