...
<html lang="en">
   <head>
      ...
      <!-- fav and touch icons -->
      <?php $favi = DB::table('nm_imagesetting')->where('imgs_type', '=', 2)->get(); ?> <?php $__currentLoopData = $favi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fav): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <link rel="shortcut icon" href="<?php echo e(url('')); ?>/public/assets/favicon/<?php echo $fav->imgs_name; ?>">
      <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo e(url('')); ?>/themes/images/ico/apple-touch-icon-144-precomposed.png">
      <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo e(url('')); ?>/themes/images/ico/apple-touch-icon-114-precomposed.png">
      <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo e(url('')); ?>/themes/images/ico/apple-touch-icon-72-precomposed.png">
      <link rel="apple-touch-icon-precomposed" href="<?php echo e(url('')); ?>/themes/images/ico/apple-touch-icon-57-precomposed.png">
...
#mixedSlider .MS-content .item {
      ...
      <?php 
         ...
         ?>
      <title><?php echo e($pro_details_by_id->$deal_title); ?></title>
   ...
   <body>
      ...
      <div class="container">
         <?php if($success1!=''): ?>
         <p class="alert alert-danger alert-dismissable "><?php echo $success1; ?></p>
         </p>
         <?php endif; ?>
         <div class="all-top">
            <div class="pro-left">
               <a id="Zoomer3"  href="<?php echo e($prod_path); ?>" class="MagicZoomPlus" rel="selectors-effect: fade; selectors-change: mouseover; " title="<?php echo e($alt_text); ?>">
               ...
               <?php endif; ?>
               <?php endif; ?>  
               <a href="<?php echo e($prod_path); ?>" rel="zoom-id: Zoomer3" rev="<?php echo e($prod_path); ?>"><img src="<?php echo e($prod_path); ?>" alt="<?php echo e($alt_text); ?>" style="width:85px; height:auto"/></a>
               <?php endfor; ?>
               <?php /*
            ...
            <div class="pro-right">
               <div class="pro-rightop">
                  <h2> 
                     ...
                     <?php $deal_title = 'deal_title'; ?>
                     <?php else: ?> <?php  $deal_title = 'deal_title_'.Session::get('lang_code'); ?> <?php endif; ?>
                     <?php echo e($pro_details_by_id->$deal_title); ?>
                  ...
                  <p class="left-label">
                     ...
                     <?php else: ?>
                     <?php echo e("No Rating for this Product"); ?>

                     <?php endif; ?>
                     <?php elseif($product_count): ?>
                     <?php $product_divide_count = $product_total_count / $product_count; ?>
                     <?php else: ?> <?php echo e("No Rating for this Deal"); ?> <?php endif; ?>
                     <span class="Review-count"><strong>(<?php echo e($count_review_rating); ?> Review & Ratings )</strong></span>
                  </p>
               </div>
               ...
               <div class="pro-mid">
                  <div class="details-left">
                     ...
                     <div class="detail-list">
                        <div class="details-left-label"><label class="left-label"><?php if(Lang::has(Session::get('lang_file').'.QUANTITY')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.QUANTITY')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.QUANTITY')); ?> <?php endif; ?> :</label></div>
                        <div class="details-left-select">
                           <div class="handle-counter" id="handleCounter">
                              <select class="form-control" name="addtocart_qty" id="addtocart_qty" >
                                 <?php   $cont_qty1 = $pro_details_by_id->deal_max_limit - $pro_details_by_id->deal_no_of_purchase; ?>
                                 <?php if($cont_qty1 > 10 ): ?> <?php echo e($cont_qty = 10); ?> <?php else: ?> <?php echo e($cont_qty = $cont_qty1); ?> <?php endif; ?>
                                 <?php for($k=1; $k <= $cont_qty; $k++): ?>
                     ...
                     <div class="detail-list">
                        ...
                        <div class="details-left-select">
                           <p class="stock-list"><?php echo e($pro_details_by_id->deal_no_of_purchase); ?> <?php if(Lang::has(Session::get('lang_file').'.SOLD')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.SOLD')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.SOLD')); ?> <?php endif; ?> / <?php echo e(($pro_details_by_id->deal_max_limit)-($pro_details_by_id->deal_no_of_purchase)); ?> <?php if(Lang::has(Session::get('lang_file').'.IN_STOCK')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.IN_STOCK')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.IN_STOCK')); ?> <?php endif; ?></p>
                        </div>
                     </div>
				  ...
				  <div class="detail-list">
					<div class="details-left-label"><label class="left-label"><?php if(Lang::has(Session::get('lang_file').'.DEAL_ENDS_IN')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.DEAL_ENDS_IN')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.DEAL_ENDS_IN')); ?> <?php endif; ?> :</label></div>
					<div class="details-left-select">
                  ...
                  <div class="Priec-right">
                     <p class="old-price"> <strike><?php echo e(Helper::cur_sym()); ?> <?php echo e($pro_details_by_id->deal_original_price); ?></strike></p>
                     <p class="new-price"> <?php echo e(Helper::cur_sym()); ?> <?php echo e($pro_details_by_id->deal_discount_price); ?> <span class="offer">(<?php echo e($pro_details_by_id->deal_discount_percentage); ?>% <?php if(Lang::has(Session::get('lang_file').'.OFFER')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.OFFER')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.OFFER')); ?> <?php endif; ?>)</span></p>
         ...
         <div class="pro-description">
            ...
            <p> 
               ...
               <?php else: ?>  <?php $deal_description = 'deal_description_'.Session::get('lang_code'); ?> <?php endif; ?>
               <?php echo e($pro_details_by_id->$deal_description); ?>
         ...
         <div class="Ratings-review">
            <div class="review-title">
               ...
               <div class="write-review">
                  ...
                  <?php else: ?> 
                  <a href="#login" role="button" data-toggle="modal"  id="login_a_click"  value="<?php if(Lang::has(Session::get('lang_file').'.LOGIN')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.LOGIN')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.LOGIN')); ?> <?php endif; ?>"><?php if(Lang::has(Session::get('lang_file').'.WRITE_A_REVIEW_POST')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.WRITE_A_REVIEW_POST')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.WRITE_A_REVIEW_POST')); ?> <?php endif; ?></a>
                  <?php endif; ?>
               </div>
            </div>
            ...
            <div class="reviews-single">
               ...
               <div class="reviews-single-right">
                  ...
                  <?php else: ?> <?php endif; ?>
                  <h5><?php echo e($customer_title); ?></h5>
                  <h6>by <?php echo e($customer_name); ?> On <?php echo e($comment_date); ?></h6>
                  <p><?php echo e($customer_comments); ?></p>
               </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!-- //foreach --> 
            <?php if($r==0): ?><?php echo e('No Reviews & Ratings.'); ?><?php else: ?> 
            <div class="more-review">
               <a href="<?php echo url('deal_review_all/'.$pro_details_by_id->deal_id);?>">More Review</a>
            </div>
            <?php endif; ?> 
            <?php else: ?><?php echo e("No Reviews & Ratings."); ?> <?php endif; ?>
         </div>
               ...
               <div class="MS-content">
                  ...
                  <div class="item">
                     <a href="<?php echo e($redirect_url); ?>">
                        ...
                        <p class="slide-product-title rltd_pdct_tl"><?php echo e(substr ($product_det->$deal_title,0,20)); ?></p>
                        <h5 class=""><?php echo e(Helper::cur_sym()); ?> <?php echo e($product_det->deal_discount_price); ?></h5>
                     </a>
                  </div>
                  <?php endif; ?> <!-- //if -->
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <!-- //foreach -->  
         ...
         <div class="your-review" id="review-comment">
            <h5 class="pro-description-title"><?php if(Lang::has(Session::get('lang_file').'.WRITE_A_REVIEW_POST')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.WRITE_A_REVIEW_POST')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.WRITE_A_REVIEW_POST')); ?> <?php endif; ?></h5>
            ...
            <div class="product-rate">
               <label class="control-label review_ratings_label" for="review_ratings" style="text-align: left;">
                  <h4><?php if(Lang::has(Session::get('lang_file').'.RATE_THIS_PRODUCT')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.RATE_THIS_PRODUCT')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.RATE_THIS_PRODUCT')); ?> <?php endif; ?></h4>
               </label>
            ...
            <div>
               <label class="control-label review_ratings_label" for="review_ratings" 
                  ...
                  <h4><?php if(Lang::has(Session::get('lang_file').'.REVIEW_THIS_PRODUCT')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.REVIEW_THIS_PRODUCT')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.REVIEW_THIS_PRODUCT')); ?> <?php endif; ?></h4>
               </label>
      ...
      <script src="<?php echo e(url('')); ?>/public/assets/js/locationpicker.jquery.js"></script>
      
      <!--Zoom image script-->
      <script src='http://code.jquery.com/jquery-1.9.1.min.js'></script>
      <script type="text/javascript" src="<?php echo e(url('')); ?>/themes/js/jquery.js"></script>
      <script src="<?php echo e(url('')); ?>/themes/js/magiczoomplus.js" type="text/javascript"></script>    
      <script type="text/javascript">
         $(document).ready(function()
         {
