   ...
   <div class="container">
      <div class="row">
         ...
         <div class="span12" style="background:#ececec;">
            <ul class="breadcrumb">
               <li class="active"><?php if(Lang::has(Session::get('lang_file').'.WELCOME_TO_USER_REGISTRATION')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.WELCOME_TO_USER_REGISTRATION')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.WELCOME_TO_USER_REGISTRATION')); ?> <?php endif; ?></li>
            </ul>
            <!--<?php if($errors->any()): ?>
               <br>
               <ul style="color:red;">
            ...
            <?php endif; ?>
            <h3 style="margin-bottom:0px; padding-left: 20px;"><?php if(Lang::has(Session::get('lang_file').'.CREATE_NEW_USER_ACCOUNT')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.CREATE_NEW_USER_ACCOUNT')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.CREATE_NEW_USER_ACCOUNT')); ?> <?php endif; ?></h3>
            <div class="content">
               <?php echo Form::open(array('url'=>'register_submit','class'=>'form-horizontal loginFrm',)); ?>
               ...
               <div class="personal-data">
                  ...
                  <div class="row">
                     <div class="span5">
                        <label for="text1" ><?php if(Lang::has(Session::get('lang_file').'.NAME')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.NAME')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.NAME')); ?> <?php endif; ?>:<span class="text-sub">*</span></label>
                        <input type="text" id="cus_name"  maxlength="75" name="customername" class="form-control span5" placeholder="<?php if(Lang::has(Session::get('lang_file').'.ENTER_YOUR_NAME')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.ENTER_YOUR_NAME')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.ENTER_YOUR_NAME')); ?> <?php endif; ?>" value="<?php echo Input::old('customername'); ?>" required/>
                        <?php if($errors->has('customername')): ?> 
                        <p class="error-block" style="color:red;"><?php echo e($errors->first('customername')); ?></p>
                        <?php endif; ?>  
                        ...
                        <!--  <input type="number" id="cus_phone" required="required" name="cus_phone" placeholder="" class="form-control span5" value="<?php echo Input::old('cus_phone'); ?>" onchange="numb();" onKeyDown="limitTextmobile(this.form.mobile,this.form.countdown,10);"  
                           onKeyUp="limitTextmobile(this.form.mobile,this.form.countdown,10);"> -->
                        <!--<input type="number" class="form-control span5" id="inputName" placeholder="" name="mobile" value="<?php echo Input::old('cus_phone'); ?>"   onchange="numb();" 
                           data-minlength="15" data-maxlength="15" data-error="Less Number"> -->   
                        <input type="text" class="form-control span5" id="inputName"  maxlength="16" placeholder="<?php if(Lang::has(Session::get('lang_file').'.ENTER_YOUR_MOBILE_NUMBER')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.ENTER_YOUR_MOBILE_NUMBER')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.ENTER_YOUR_MOBILE_NUMBER')); ?> <?php endif; ?>" name="mobile" value="<?php echo Input::old('mobile'); ?>"   onkeypress="return isNumber(event)" 
                           data-minlength="15" data-maxlength="15" data-error="Less Number" required>			  
                        <?php if($errors->has('mobile')): ?> 
                        <p class="error-block" style="color:red;"><?php echo e($errors->first('mobile')); ?></p>
                        <?php endif; ?>  
                        <label for="text1"><?php if(Lang::has(Session::get('lang_file').'.EMAIL')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.EMAIL')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.EMAIL')); ?> <?php endif; ?>:<span class="text-sub" >*</span></label>
                        <input type="email" maxlength="50" id="cus_email" name="email" placeholder="<?php if(Lang::has(Session::get('lang_file').'.ENTER_YOUR_EMAIL')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.ENTER_YOUR_EMAIL')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.ENTER_YOUR_EMAIL')); ?> <?php endif; ?>" class="form-control span5" value="<?php echo Input::old('email'); ?>" required onChange="check();"  />
                        ...
                        <?php endif; ?> 
                        <label for="text1" ><?php if(Lang::has(Session::get('lang_file').'.PASSWORD')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.PASSWORD')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.PASSWORD')); ?> <?php endif; ?>:<span class="text-sub" >*</span></label>
                        ...
                        <p class="error-block" style="color:red;"><?php echo e($errors->first('pwd')); ?></p>
                        <?php endif; ?> 
                        ...
                        <p class="error-block" style="color:red;"><?php echo e($errors->first('select_country')); ?></p>
                        <?php endif; ?>
                        ...
                        <?php if($errors->has('select_city')): ?> 
                        <p class="error-block" style="color:red;"><?php echo e($errors->first('select_city')); ?></p>
                        <?php endif; ?>
                        <input type="hidden" id="return_url" value="<?php echo $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'];?>" />
                        <p><input type="checkbox" required/> <?php if(Lang::has(Session::get('lang_file').'.BY_CLICKING_SIGNUP_I_AGREE_TO')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.BY_CLICKING_SIGNUP_I_AGREE_TO')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.BY_CLICKING_SIGNUP_I_AGREE_TO')); ?> <?php endif; ?>  <?php echo e($SITENAME); ?> <a href="<?php echo e(url('termsandconditons')); ?>" title="<?php if(Lang::has(Session::get('lang_file').'.TERMS_AND_CONDITIONS')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.TERMS_AND_CONDITIONS')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.TERMS_AND_CONDITIONS')); ?> <?php endif; ?>" class="forget_link" style="color:#ff8400;" target="_blank" > <?php if(Lang::has(Session::get('lang_file').'.TERMS_AND_CONDITIONS')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.TERMS_AND_CONDITIONS')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.TERMS_AND_CONDITIONS')); ?> <?php endif; ?></a>		
                        </p>
                        <input type="submit" id="register_submit" class="btn btn-success" value="<?php if(Lang::has(Session::get('lang_file').'.SIGN_UP')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.SIGN_UP')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.SIGN_UP')); ?> <?php endif; ?>" />          
                     </div>
                     <div class="span6" style="margin-top: 10%;">
                        <div class="clearfix fb-log" style="text-align:center">
                           <span style="font-size:16px; color:#666; text-align:center; line-height:10px"><?php if(Lang::has(Session::get('lang_file').'.CONNECT_YOUR_FACEBOOK_ACCOUNT_FOR_SIGN_UP')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.CONNECT_YOUR_FACEBOOK_ACCOUNT_FOR_SIGN_UP')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.CONNECT_YOUR_FACEBOOK_ACCOUNT_FOR_SIGN_UP')); ?> <?php endif; ?> <?php echo e($SITENAME); ?> .</span><br>
                     ...
                     <div class="clearfix fb-log" style="text-align:center" >
                           ...
                           <?php if(Lang::has(Session::get('lang_file').'.ALREADY_A_MEMBER')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.ALREADY_A_MEMBER')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.ALREADY_A_MEMBER')); ?> <?php endif; ?> ? <a href="#login" onClick="$('.close').click();" role="button" data-toggle="modal" style="color:#ff8400;"><?php if(Lang::has(Session::get('lang_file').'.LOGIN')!= ''): ?> <?php echo e(trans(Session::get('lang_file').'.LOGIN')); ?> <?php else: ?> <?php echo e(trans($OUR_LANGUAGE.'.LOGIN')); ?> <?php endif; ?></a>
