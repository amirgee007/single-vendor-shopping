...
class Country extends Model
{
    ...
    {
        return DB::table('nm_country')->orderby('co_id','desc')->get();
    }
    ...
    public static function update_merchant_country_status($country_id,$array){ //block merchant when blocking country
        return DB::table('nm_merchant')->where('mer_co_id','=',$country_id)->where('mer_country_status','=','A')->update($array);
    }
