...
class Admodel extends Model
{
	...
	public static function check_exist_ad_position($adposition)
    {
        return DB::table('nm_add')->where('ad_position', '=', $adposition)->count();
    }
	...
	public static function get_admin_ads($admin_ad)
	{
        return DB::table('nm_add')->update($admin_ad);
    }
