    ...
    if (count($all_product_deatils) > 0)
    {
      ...
      foreach($all_product_deatils as $row)
      {
        ...
        $lineData = array(
            ...
            "$row->pro_sh_id",
            "$row->pro_mkeywords",
            "$row->pro_mkeywords_fr",
            "$row->pro_mdesc",
            "$row->pro_mdesc_fr",
            "$row->pro_postfacebook",
            "$row->pro_Img",
            "$row->created_date",
            "$row->pro_status",
            "$row->pro_image_count",
            ...
            "$row->allow_replace",
            "$row->cancel_policy",
            "$row->cancel_policy_fr",
            "$row->return_policy",
            "$row->return_policy_fr",
            "$row->replace_policy",
            "$row->replace_policy_fr",
            "$row->cancel_days",
            "$row->return_days",
            "$row->replace_days",
            "$row->stor_id",
            "$row->stor_merchant_id",
            "$row->stor_name",
            "$row->stor_name_fr",
            "$row->stor_phone",
            "$row->stor_address1",
            "$row->stor_address1_fr",
            "$row->stor_address2",
            "$row->stor_address2_fr",
            "$row->stor_country",
            "$row->stor_city",
            "$row->stor_zipcode",
            "$row->stor_metakeywords",
            "$row->stor_metakeywords_fr",
            "$row->stor_metadesc",
            "$row->stor_metadesc_fr",
            "$row->stor_website",
            "$row->stor_latitude",
            "$row->stor_longitude",
            "$row->stor_img",
