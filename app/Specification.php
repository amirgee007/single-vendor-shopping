...
class Specification extends Model
{
	...
	public static function get_main_cat_for_specification_group()
    {
        return DB::table('nm_maincategory')->where("mc_status","=","1")->get();
    }
	public static function get_sec_main_cat_for_specification_group_manage()
    {
        return DB::table('nm_secmaincategory')->where("smc_status","=","1")->get();
    }
	
	public static function get_sec_main_cat_for_specification_group($category_id)
    {
        return DB::table('nm_secmaincategory')->where("smc_mc_id","=",$category_id)->get();
    }
    ...
    {
         DB::table('nm_spgroup')->where('spg_id', '=', $id)->delete();
         return DB::table('nm_specification')->where('sp_spg_id', '=', $id)->delete();
    }
}
?>
